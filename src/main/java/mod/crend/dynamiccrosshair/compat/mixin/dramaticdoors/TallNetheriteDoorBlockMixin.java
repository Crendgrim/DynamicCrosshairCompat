...
@Mixin(value = TallNetheriteDoorBlock.class, remap = false)
public class TallNetheriteDoorBlockMixin extends TallDoorBlockMixin implements DynamicCrosshairBlock {
	@Override
